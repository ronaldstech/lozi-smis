...
import { AddCircle, Edit2, CloseCircle, TickCircle } from "iconsax-react";
    ...
    <Box>
              ...
              {loading ? (
                ...
                grades.map((row, index) => (
                  <TableRow key={index} hover>
                    ...
                    <TableCell>
                      {row.min_mark} - {row.max_mark}
                    </TableCell>
                    <TableCell>
                      <Chip
                        label={row.grade}
                        size="small"
                        sx={{ fontWeight: 700, bgcolor: "#f137c3ff" }}
                        color="primary"
                      />
                    </TableCell>
      ...
      >
        ...
        <form onSubmit={(e) => handleSave(e, "add")} style={{ padding: 24 }}>
          <Typography
            variant="caption"
            sx={{ color: "#ef4444", mb: 2, display: "block" }}
          >
            Academic Name: {academic.name}
          </Typography>
        ...
        <form onSubmit={(e) => handleSave(e, "edit")} style={{ padding: 24 }}>
          ...
          <Stack direction="row" spacing={2} sx={{ mb: 2 }}>
            <TextField
              ...
              name="min_mark_edit"
              value={edit.min_mark || ""}
              onChange={(e) => setEdit({ ...edit, min_mark: e.target.value })}
              size="small"
              fullWidth
              required
            />
            <TextField
              ...
              name="max_mark"
              value={edit.max_mark || ""}
              onChange={(e) => setEdit({ ...edit, max_mark: e.target.value })}
              size="small"
              fullWidth
              required
            />
