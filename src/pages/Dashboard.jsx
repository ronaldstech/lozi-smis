...
function Dashboard() {
  ...
  return (
    <Box
      className="mesh-bg"
      sx={{ px: { xs: 1, md: 3 }, py: { xs: 2.5, md: 4 }, minHeight: "100vh" }}
    >
      {/* Header */}
      <Stack
          ...
          >
            ...
            <Stack spacing={0} sx={{ position: "relative" }}>
              {[
                {
                  user: "System",
                  action: "Grading schema updated for Term 2.",
                  time: "2h ago",
                  color: "#6366f1",
                ...
                {
                  user: "Admin",
                  action: "5 new students enrolled in Class 10A.",
                  time: "5h ago",
                  color: "#10b981",
                ...
                {
                  user: "Staff",
                  action: "Mid-term results published successfully.",
                  time: "1d ago",
                  color: "#f59e0b",
          ...
          <Box sx={{ height: "100%" }}>
            ...
            >
              <Box sx={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  Your school is performing 15% better than last semester. Keep
                  it up!
                </Typography>
              </Box>
              <Graph
