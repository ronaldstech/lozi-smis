                    ...
                    <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} alignItems={{ xs: 'flex-start', md: 'center' }} sx={{ flexGrow: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            <Box sx={{
                                ...
                                <Buildings size={24} variant="Bulk" />
                            </Box>
                            <Box>
                                ...
                                <Table stickyHeader>
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            >
                                                Exam <Typography variant="caption" sx={{ display: 'block', opacity: 0.6 }}>(100%)</Typography>
                                            </TableCell>
                                            <TableCell
                                                sx={{
                                                    bgcolor: '#f8fafc', fontWeight: 800, color: '#475569',
                                        ...
                                        {studentLoading ? (
                                            ...
                                            <TableRow>
                                                <TableCell colSpan={4} align="center" sx={{ py: 10 }}>
                                                    <Box sx={{ opacity: 0.4 }}>
                                                        <Eye size={60} variant="Broken" style={{ marginBottom: 16 }} />
